<x-admin_layout>
    <div class="flex-1">
        <div class="flex justify-between items-center mb-8 border-b border-stone-200 dark:border-gray-700 pb-2">
            <div>
                <h2 class="text-3xl font-bold text-content-light dark:text-content-dark">Staff Management</h2>
                <p class="text-subtle-light dark:text-subtle-dark mt-1">Manage Staff accounts,logs, and
                    permissions.</p>
            </div>
            <button
