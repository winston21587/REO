    ...
    <div id="analytics-dashboard" class="max-w-7xl mx-auto space-y-8 animate-[fadeInUp_0.5s_ease-out]">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-end pb-6 border-b border-slate-200 gap-4">
            ...
            <div class="flex gap-2 sm:gap-3 items-center flex-wrap justify-start sm:justify-end w-full md:w-auto">
                <button onclick="openFilterModal()" aria-label="Open filter options" class="px-3 sm:px-4 py-2 bg-gradient-to-r from-[#8B0000] to-red-700 text-white rounded-lg text-xs font-bold uppercase tracking-wider hover:shadow-lg active:scale-[0.98] transition-all flex items-center gap-2 shadow-sm min-h-[38px] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#8B0000] focus-visible:ring-offset-2">
                    <i class="fas fa-filter" aria-hidden="true"></i> Filter Data
                </button>

                <div class="hidden sm:block h-8 w-px bg-slate-200"></div>

                <button id="exportPdfBtn" onclick="exportToPdf()" aria-label="Export report as PDF" class="min-h-[38px] px-3 sm:px-4 py-2 bg-white border border-slate-200 text-slate-600 rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-slate-50 active:scale-[0.98] transition-all shadow-sm flex items-center gap-2 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-400 focus-visible:ring-offset-2">
                    <i class="fas fa-download" aria-hidden="true"></i> Export PDF
                </button>

                <a href="{{ route('super_admin.analytics.export', request()->query()) }}" id="exportCsvBtn" aria-label="Export report data as CSV file" class="px-3 sm:px-4 py-2 bg-white border border-slate-200 text-[#8B0000] rounded-lg text-xs font-bold uppercase tracking-wider hover:bg-slate-50 active:scale-[0.98] transition-all shadow-sm flex items-center gap-2 min-h-[38px] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#8B0000] focus-visible:ring-offset-2">
                    <i class="fas fa-file-csv text-sm" aria-hidden="true"></i> Export CSV
                </a>
                <!-- EXPORT TO WORD BTN -->
                <a href="{{ route('super_admin.analytics.export_word', request()->query()) }}" id="exportWordBtn" aria-label="Export report data as Word document" class="px-3 sm:px-4 py-2 bg-white border border-slate-200 text-slate-700 hover:text-[#8B0000] hover:border-[#8B0000]/30 hover:bg-slate-50 active:scale-[0.98] rounded-lg text-xs font-bold uppercase tracking-wider transition-all shadow-sm flex items-center gap-2 min-h-[38px] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#8B0000] focus-visible:ring-offset-2">
