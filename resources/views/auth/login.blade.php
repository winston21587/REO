    ...
    <div class="min-h-screen flex h-screen overflow-hidden">
        ...
        <div class="hidden md:flex w-1/2 relative text-white flex-col justify-center p-12 lg:p-16">
            <div class="absolute inset-0 z-0">
                <img src="{{ isset($contents['login_image']) ? asset($contents['login_image']) : asset('images/wmsu1.jpg') }}"
            ...
            <div class="relative z-10 max-w-lg animate-[fadeInUp_0.8s_ease-out]">
                <div class="w-16 h-16 flex items-center justify-center mb-8">
                    <img src="{{isset($cms['website_logo']) ? asset($cms['website_logo']) : '' }}"
                        class="w-10 h-10 drop-shadow-md">
                </div>

                <h1
                    class="text-5xl lg:text-6xl font-extrabold font-heading tracking-tight leading-tight drop-shadow-xl">
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center p-8 bg-white relative">
            ...
            <div class="w-full max-w-md relative z-10">
                ...
                @if(session('success'))
                    <div
                        class="bg-green-50 border border-green-200 text-green-800 text-xs font-bold px-4 py-3 rounded-xl mb-6 flex items-center gap-2">
                ...
                @if(session('error'))
                    <div
                        class="bg-red-50 border border-red-200 text-red-800 text-xs font-bold px-4 py-3 rounded-xl mb-6 flex items-center gap-2">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <button type="submit"
                        class="w-full bg-[#8B0000] hover:bg-red-900 text-white font-bold py-4 rounded-xl shadow-lg shadow-red-900/20 transition-all duration-200 flex justify-center items-center gap-2 group mt-8">
                        <span>Sign In</span>
