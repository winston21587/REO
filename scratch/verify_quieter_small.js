...
(async () => {
    ...
    // Test viewports: 1440x900 (desktop) and 1366x768 (typical laptop)
    const viewports = [
    ...
    for (const vp of viewports) {
        ...
        const measurements = await page.evaluate(() => {
            ...
            const cards = Array.from(document.querySelectorAll('#recent-submissions-container .bg-white'));
            ...
            return {
                ...
                recentColHeight: recentCol ? recentCol.getBoundingClientRect().height : 0,
                incompleteColHeight: incompleteCol ? incompleteCol.getBoundingClientRect().height : 0,
