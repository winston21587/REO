...
<head>
    ...
    <title>404 • Page Not Found — WMSU REO</title>
        ...
        <div class="w-full max-w-lg bg-white rounded-2xl border border-slate-200/90 shadow-xl shadow-slate-900/5 overflow-hidden animate-[fadeInUp_0.4s_ease-out]">
            ...
            <div class="p-6 sm:p-8 text-center">
                ...
                <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-2xl bg-red-50 border border-red-100 text-[#8B0000] flex items-center justify-center mx-auto mb-5 shadow-xs">
                    <i class="fas fa-compass text-2xl sm:text-3xl" aria-hidden="true"></i>
                </div>

                <!-- Headline -->
                <div class="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-700 text-xs font-bold uppercase tracking-wider mb-3">
                ...
                <p class="text-xs sm:text-sm text-slate-600 mb-6 leading-relaxed">
                    The requested protocol record, resource, or portal page could not be located or has been relocated within the REO system.
                </p>
                    ...
                    <div class="bg-slate-50 border border-slate-200/80 rounded-xl p-4 sm:p-4.5 text-left mb-6 space-y-3">
                        ...
                        <div class="border-t border-slate-200/70 pt-2.5">
                            <p class="text-[11px] text-slate-600 leading-snug">
                                You are signed in. You can return directly to your active role workspace below.
                            </p>
                        </div>
                    </div>
                ...
                @else
                    ...
                    <div class="bg-slate-50 border border-slate-200/80 rounded-xl p-4 text-left mb-6">
                        <p class="text-xs text-slate-600 leading-relaxed">
                            The link you followed may be incorrect, expired, or require institutional authentication.
                        </p>
                    </div>

                    <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                        <a href="{{ route('index') }}"
                           class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-[#8B0000] hover:bg-[#700000] active:scale-[0.98] text-white font-bold text-xs sm:text-sm shadow-md hover:shadow-lg transition-all duration-150 min-h-[44px] cursor-pointer focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#8B0000]">
                            <i class="fas fa-home text-xs" aria-hidden="true"></i>
                            <span>REO Public Home</span>
                        </a>

                        <a href="{{ route('login') }}"
                           class="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-white hover:bg-slate-50 active:scale-[0.98] border border-slate-300 text-slate-700 font-semibold text-xs sm:text-sm shadow-2xs hover:border-slate-400 transition-all duration-150 min-h-[44px] cursor-pointer">
