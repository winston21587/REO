        ...
        <aside class="w-72 bg-[#1a0505] text-white flex flex-col shadow-2xl z-50 relative">
            <div
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="font-heading font-bold text-lg tracking-wide">REO Super Admin</h1>
                        <p class="text-[10px] text-slate-400 uppercase tracking-widest">System Oversight</p>
                    </div>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="space-y-1">
                        <a href="{{ route('super_admin.analytics') }}"
                            class="nav-item flex items-center gap-3 px-4 py-3 rounded-r-lg text-sm font-medium text-slate-400 hover:bg-white/5 hover:text-white transition-all {{ request()->routeIs('super_admin.analytics') ? 'active' : '' }}">
            ...
            <div class="p-4 border-t border-white/10 bg-black/20">
                <div class="flex items-center gap-3 px-2">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-xs text-slate-400 truncate">Super Administrator</p>
                    </div>
