<x-super_admin_layout>
    ...
    <div x-data="{ 
        ...
        <form method="GET" action="{{ route('super_admin.manage_admins') }}" class="bg-white p-4 md:p-5 rounded-2xl border border-slate-200/80 shadow-xs flex flex-col md:flex-row gap-4 items-stretch md:items-center">
            <!-- Search -->
                ...
                <table class="w-full text-left border-collapse min-w-[700px]">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        ...
                        <tr class="hover:bg-slate-50/70 transition-colors">
                            ...
                            <!-- Affiliation & Label (High-Contrast Semantic Typography - NO pills, NO dots) -->
                            <td class="py-4 px-6">
