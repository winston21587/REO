<x-super_admin_layout>
    <div x-data="{ showAddModal: false, showViewModal: false, selectedUser: null }" class="max-w-7xl mx-auto space-y-8 animate-[fadeInUp_0.5s_ease-out]">
        ...
        <!-- Search & Filter -->
        <form method="GET" action="{{ route('super_admin.manage_reviewers') }}" class="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm flex flex-col md:flex-row gap-4 items-center">
