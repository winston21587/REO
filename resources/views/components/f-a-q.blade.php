  ...
  <div class="bg-background-light dark:bg-background-dark font-display">
    ...
    >
      <div
        class="bg-background-light dark:bg-background-dark rounded-xl shadow-2xl w-full max-w-2xl m-4 flex flex-col"
      >
        <div
          class="flex items-center justify-between p-6 border-b border-border-light dark:border-border-dark"
        >
          <h2
            class="text-xl font-bold text-content-light dark:text-content-dark"
          >
            Frequently Asked Questions
          </h2>
          <button
            class="text-subtle-light dark:text-subtle-dark hover:bg-primary/10 dark:hover:bg-primary/20 rounded-full p-2 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background-light dark:focus:ring-offset-background-dark"
          >
            <svg
              class="h-6 w-6"
              fill="none"
        ...
        <div class="p-6 space-y-4 overflow-y-auto max-h-[70vh]">
          ...
          >
            <summary
              class="flex cursor-pointer items-center justify-between p-4 list-none"
            >
              <span
                class="font-medium text-content-light dark:text-content-dark"
                >How do I submit a file?</span
              >
              <svg
          ...
          >
            ...
            >
              <span
                class="font-medium text-content-light dark:text-content-dark"
                >What file types are accepted?</span
              >
              <svg
                class="h-5 w-5 text-subtle-light dark:text-subtle-dark transition-transform duration-300 group-open:rotate-180"
                fill="none"
          ...
          >
            ...
            >
              <span
                class="font-medium text-content-light dark:text-content-dark"
                >How long does the review process take?</span
              >
              <svg
                class="h-5 w-5 text-subtle-light dark:text-subtle-dark transition-transform duration-300 group-open:rotate-180"
                fill="none"
          ...
          >
            ...
            >
              <span
                class="font-medium text-content-light dark:text-content-dark"
                >Can I edit my submission after it's been submitted?</span
              >
              <svg
                class="h-5 w-5 text-subtle-light dark:text-subtle-dark transition-transform duration-300 group-open:rotate-180"
                fill="none"
          ...
          >
            ...
            >
              <span
                class="font-medium text-content-light dark:text-content-dark"
                >Who can I contact for technical support?</span
              >
              <svg
                class="h-5 w-5 text-subtle-light dark:text-subtle-dark transition-transform duration-300 group-open:rotate-180"
                fill="none"
        ...
        <div
          class="p-6 border-t border-border-light dark:border-border-dark flex justify-end"
        >
          <button
            class="bg-primary text-white font-bold py-2 px-6 rounded-lg hover:bg-opacity-90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background-light dark:focus:ring-offset-background-dark transition-colors duration-200"
          >
            Close
          </button>
        </div>
