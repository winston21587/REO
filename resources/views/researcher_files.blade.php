    ...
    <main class="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div x-data="{ 
            ...
            <div class="flex gap-2 border-b border-slate-200 mb-8 overflow-x-auto custom-scrollbar">
                ...
                {{-- Original Documents tab: always shown when files with revision_number=null exist --}}
            ...
            <div x-show="activeTab === 'rev_{{ $revNum }}'" style="display: none;">
                <div class="bg-slate-50 rounded-3xl border border-slate-200 p-6">
                    <div class="flex items-center justify-between mb-6 pb-4 border-b border-slate-200/60">
                        <h4 class="text-lg font-bold text-slate-700 flex items-center gap-3">
                            <i class="fas fa-folder text-slate-400 text-2xl"></i>
                            Revision {{ $revNum }}
                        </h4>
                ...
                @foreach($files as $file)
                    ...
                    <div class="group bg-white rounded-2xl border border-slate-200 overflow-hidden hover:shadow-xl hover:shadow-slate-200/50 hover:border-slate-300 transition-all duration-300 flex flex-col">
                        ...
                        <!-- Actions -->
                        <div class="p-3 bg-slate-50/50 mt-auto">
                            <a href="{{ asset($file->filepath) }}" download class="block w-full py-2 px-4 bg-white hover:bg-slate-100 text-slate-600 hover:text-slate-900 rounded-xl text-xs font-bold text-center border border-slate-200 transition-colors flex items-center justify-center gap-2">
