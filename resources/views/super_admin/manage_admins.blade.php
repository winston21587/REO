<x-super_admin_layout>
    <div x-data="{ showAddModal: false, showViewModal: false, selectedUser: null }" class="max-w-7xl mx-auto space-y-8 animate-[fadeInUp_0.5s_ease-out]">
        ...
        <div class="flex flex-col md:flex-row justify-between items-end pb-6 border-b border-slate-200">
            <div>
                <h1 class="text-3xl font-extrabold text-slate-900 font-heading tracking-tight">Admins</h1>
                <p class="text-slate-500 mt-2 text-sm">Directory of system administrators.</p>
            </div>
                    ...
                    <div class="bg-white px-6 pt-6 pb-4 border-b border-slate-50">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-slate-900" id="modal-title">Add New Admin</h3>
                                    <p class="text-xs text-slate-500">Create a new account for an administrator.</p>
                                </div>
                            </div>
                    ...
                    <div class="bg-white px-6 pt-6 pb-4 border-b border-slate-50">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 class="text-lg font-bold text-slate-900">Admin Details</h3>
                                    <p class="text-xs text-slate-500">View complete admin information.</p>
                                </div>
                            </div>
