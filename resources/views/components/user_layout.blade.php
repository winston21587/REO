...
<body>
<header>
    <nav class="h-[70px] relative w-full px-6 md:px-16 lg:px-24 xl:px-32 flex items-center justify-between z-30 bg-gradient-to-r from-red-700 to-pink-600 transition-all">
        ...
        <ul class="text-white md:flex hidden items-center gap-10">
            ...
            <li><a class="hover:text-white/70 transition" href="{{ route('submission') }}">Submit Application</a></li>
            <li><a class="hover:text-white/70 transition" href="{{ route('resources') }}">Resources</a></li>
            <li><a class="hover:text-white/70 transition" href="#">FAQ</a></li>
            <li><a class="hover:text-white/70 transition" href="{{ route('instructions') }}">instructions</a></li>
            {{-- <li><a class="hover:text-white/70 transition" href="{{ route('profile') }}">profile</a></li> --}}
        </ul>
        ...
        <div class="mobile-menu absolute top-[70px] left-0 w-full bg-gradient-to-r from-indigo-700 to-violet-500 p-6 hidden md:hidden">
            <ul class="flex flex-col space-y-4 text-white text-lg">
                ...
                <li><a href="{{ route('submission') }}" class="text-sm">submit Application</a></li>
                <li><a class="hover:text-white/70 transition" href="{{ route('resources') }}">Resources</a></li>
                <li><a href="#" class="text-sm">FAQ</a></li>
                <li><a href="{{ route('instructions') }}" class="text-sm">Instructions</a></li>
                <li><a href="{{ route('instructions') }}" class="text-sm">Instructions</a></li>
            </ul>
            <form action="{{ route('logout') }}" method="POST">
                <button type="button" class="bg-white text-gray-700 mt-6 inline md:hidden text-sm hover:opacity-90 active:scale-95 transition-all w-40 h-11 rounded-full">Logout</button>
            </form>
        </div>
    </nav>
</header>
